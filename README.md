...
SCAN-B (GSE96058) dataset. Normalized RNA-seq expression and clinical tables were obtained from NCBI GEO (accession GSE96058). In the respective folder, we provide scripts to preprocess the files directly downloaded from GEO. We include only small, de-identified example subsets in this repository to keep the repo light and avoid duplicating large third-party datasets.
